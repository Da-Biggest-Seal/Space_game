...
class Enemy:
    def __init__(self, pozice_enemy_x, pozice_enemy_y, rozliseni_x, rozliseni_y, okno, enemy_idle, Pocet_LVL_1):
    ...
    def vykresli_se(self):
        for i in range(self.Pocet_LVL_1):
            print(self.Pocet_LVL_1)
